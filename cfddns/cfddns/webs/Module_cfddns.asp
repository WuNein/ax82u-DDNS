...
var noChange = 0;
var x = 5;
var params_inp = ['cfddns_email', 'cfddns_akey', 'cfddns_zid', 'cfddns_name', 'cfddns_domain', 'cfddns_ttl', 'cfddns_method', 'cfddns_id'];
							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div class="SimpleNote" id="head_illustrate"><i></i><em>CloudFlare DDNS是基于 CloudFlare API实现的个人DDNS工具。Ui modified </em></div>
										...
										<div id="cfddns_settings" style="margin:-1px 0px 0px 0px;">
											<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<tr>
													<th>DNS ID</th>
													<td>
														<input type="password" name="cfddns_id" id="cfddns_id" class="input_ss_table" style="width:340px;" autocomplete="off" autocorrect="off" autocapitalize="off" maxlength="300" readonly onBlur="switchType(this, false);" onFocus="switchType(this, true);this.removeAttribute('readonly');" value="" />
													</td>
												</tr>
												<tr>
